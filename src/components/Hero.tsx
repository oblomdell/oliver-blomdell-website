...
export default function Hero() {
    return (
        <section className="min-h-screen flex flex-col md:flex-row-reverse justify-center md:justify-evenly md:items-center gap-[20px] mb-[60px] md:mb-[100px] xl:mb-[200px]">
